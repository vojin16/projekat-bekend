...
import com.example.projekat.dao.RoleDao;
import com.example.projekat.dao.UserDao;
...
public class UserService {
    ...
    public void initRoleAndUser() {
        ...
        user.setUserPassword(getEncodedPassword("Vojin123"));
        user.setUserFirstName("Vojin");
        user.setUserLastName("Cirkovic");
